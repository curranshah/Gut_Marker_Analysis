...
A pipeline for extracting marker genes from single-cell RNA-seq (scRNA-seq) data using a Variational Autoencoder (VAE). Developed for analyzing human gut tissue datasets (fetal, pediatric, and adult).  Using data from Elmentaite et al., 2021 Cells of the human intestinal tract mapped across space and time
